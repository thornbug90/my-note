...
export const interview = [
    ...
    {
        title: "How do you handle stress, pressure, and anxiety?",
        type: 0,
        content: `When I get stressed, I open the window and look over the sky.
        And listen.
        ...
        My mental strength comes from my father. No pressure, No diamonds.`
    },
    {
    ...
    {
        title: "Is there anything that makes you different from other candidates? ",
        type: 0,
        content: `I don't want to underestimate the other candidates.
